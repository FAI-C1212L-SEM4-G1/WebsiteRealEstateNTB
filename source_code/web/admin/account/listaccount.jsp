                    ...
                    <div id="cph_Main_ContentPane">
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div class="span9">
                                    <form action="${pageContext.request.contextPath}/ControllerAccount" method="GET">
                                        <div class="span9 form-search pull-right text-right" style="float:left;margin-bottom:10px;">
                                            ...
                                            <select id="typeSearch" name="typeSearch">
                                                <option value="byLoginId">Search by username</option>
                                                <option value="byFullName">Search by name</option>
                                                <option value="byStatus" selected>Search by status</option>
                                                <option value="byGender">Search by gender</option>
                                                <option value="byAddress">Search by address</option>
                                                <option value="byEmail">Search by email</option>
                                                <option value="byTel">Search by telephone</option>
                                            </select>
                                ...
                                <div>
                                    <table id="cph_Main_ctl00_ctl00_grvProducts" class="table table-striped table-bordered dataTable table-hover" cellspacing="0" style="border-collapse:collapse;">
                                        ...
                                        <tbody>
                                            <core:forEach items="${requestScope.listData}" var="account">                                                                                            
                                                <tr>
                                                    <td class="Visible text-center" align="center" style="width:30px;">${account.loginId}</td>
                                                    <td class="Visible text-center" align="left" style="width:45px;"> ${account.person.fullname} </td>
                                                    <td class="text-center" align="center" style="width:30px;"> ${account.person.birthday} </td>
                                                    <td class="text-center" align="center" style="width:30px;"> ${account.status} </td>
                                                    <td class="Visible text-center" align="left" style="width:45px;"> ${account.person.email} </td>
                                                    <td class="Visible text-center" align="center" style="width:45px;">
                                                        <a id="lbtUpdateProduct2946698" class="action-link-button" title="Edit account" href="${pageContext.request.contextPath}/ControllerAccount?action=edit&code=${account.loginId}">
                                                            <i class="fa fa-pencil-square-o"></i>
                                                        </a>
                                                        <a class="action-link-button" title="Delete this account" href="${pageContext.request.contextPath}/ControllerAccount?action=delete&code=${account.loginId}">
                                                ...
                                                <ul class="pagination">
                                                    <core:forEach begin="1" end="${noOfPages}" var="i" >
                                                        <core:choose>
                                                            ...
                                                            <core:otherwise>
                                                                <li>
                                                                    <a href="${pageContext.request.contextPath}/ControllerAccount?action=list&page=${i}">${i}</a>
                                                                </li>
                                                            </core:otherwise>  
                                                        </core:choose>                                                                                                              
                                                    </core:forEach>
                                                    <core:if test="${currentPage lt noOfPages}">
                                                        <li class="PagedList-skipToNext">
                                                            <a rel="next" href="${pageContext.request.contextPath}/ControllerAccount?action=list&page=${i+1}">»</a>
                                                        </li>
                                                    </core:if>                                                    
                                                </ul>
                                            </div>
