<%-- 
    Document   : List view regional price
    Author     : PhanAnh
--%>
                    ...
                    <div id="cph_Main_ContentPane">
                        <div class="widget">
                            ...
                            <div class="widget-body">
                                <div class="span9">
                                    <form action="${pageContext.request.contextPath}/ControllerRegionalPrice" method="GET">
                                        <div class="span9 form-search pull-right text-right" style="float:left;margin-bottom:10px;">
                                            ...
                                            <select id="typeSearch" name="typeSearch">
                                                <option value="byRegionalName" selected>Search by location</option>
                                ...
                                <div>
                                    <table id="cph_Main_ctl00_ctl00_grvProducts" class="table table-striped table-bordered dataTable table-hover" cellspacing="0" style="border-collapse:collapse;">
                                        ...
                                        <tbody>
                                            <core:forEach items="${requestScope.listData}" var="regionalPrice">                                                                                            
                                                <tr>
                                                    <td class="Visible text-center" align="center" style="width:30px;">${regionalPrice.code}</td>
                                                    <td class="Visible text-center" align="center" style="width:45px;"> ${regionalPrice.regionalName} </td>
                                                    <td class="text-center" align="center" style="width:30px;"> ${regionalPrice.city} </td>
                                                    <td class="text-center" align="center" style="width:30px;"> ${regionalPrice.country} </td>
                                                    <td class="Visible text-center" align="center" style="width:45px;"> ${regionalPrice.unitPrice} </td>
                                                    <td class="Visible text-center" align="center" style="width:45px;">
                                                        <a id="lbtUpdateProduct2946698" class="action-link-button" title="Edit regional price" href="${pageContext.request.contextPath}/ControllerRegionalPrice?action=edit&code=${regionalPrice.code}">
                                                            <i class="fa fa-pencil-square-o"></i>
                                                        </a>
                                                        <a class="action-link-button" title="Delete this regional price" href="${pageContext.request.contextPath}/ControllerRegionalPrice?action=delete&code=${regionalPrice.code}">
                                                ...
                                                <ul class="pagination">
                                                    <core:forEach begin="1" end="${noOfPages}" var="i" >
                                                        <core:choose>
                                                            ...
                                                            <core:otherwise>
                                                                <li>
                                                                    <a href="${pageContext.request.contextPath}/ControllerRegionalPrice?action=list&page=${i}">${i}</a>
                                                                </li>
                                                            </core:otherwise>  
                                                        </core:choose>                                                                                                              
                                                    </core:forEach>
                                                    <core:if test="${currentPage lt noOfPages}">
                                                        <li class="PagedList-skipToNext">
                                                            <a rel="next" href="${pageContext.request.contextPath}/ControllerRegionalPrice?action=list&page=${i+1}">»</a>
                                                        </li>
                                                    </core:if>                                                    
                                                </ul>
                                            </div>
